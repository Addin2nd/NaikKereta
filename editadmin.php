...
$adm = query("SELECT * FROM adminn WHERE id = $id")[0];
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-danger elevation-4">
            <!-- Brand Logo -->
            <a href="manager2.php" class="brand-link">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="username" class="form-control"
                                                        id="username" required value="<?php echo $adm["username"] ?>" />
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="email" class="form-control" id="email"
                                                        required value="<?php echo $adm["email"] ?>" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="password" class="form-control"
                                                        id="password" required value="<?php echo $adm["password"] ?>" />
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="gambar">Input Profile Picture</label>
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input" id="gambar"
                                                                name="gambar" accept="Image/jpg,Image/jpeg,Image/png" />
                                                            <label class="custom-file-label" for="gambar" required
                                                                value="<?php echo $adm["gambar"]; ?>">Choose
                                                                file</label>
                                                        </div>
                                                    </div>
                                                </div>
