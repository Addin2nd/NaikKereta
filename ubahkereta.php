...
$krt = query("SELECT * FROM kereta WHERE id = $id")[0];
...
<head>
    ...
    <title>Manager Home | Edit Train Data</title>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="card card-danger">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Train Data</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="" method="POST">
                                    <input type="hidden" name="id" value=" <?= $krt["id"]; ?>">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-6">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="harga">Train Fare</label>
                                                    <input type="text" name="harga" class="form-control" id="harga"
                                                        required value="<?php echo $krt["harga"] ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="kelas" class="form-control" id="kelas"
                                                        required value="<?php echo $krt["kelas"] ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="jurusan" class="form-control" id="jurusan"
                                                        required value="<?php echo $krt["jurusan"] ?>" />
                                                </div>
                                            </div>
                                        </div>
