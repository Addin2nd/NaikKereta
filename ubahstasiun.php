...
$sts = query("SELECT * FROM stasiun WHERE id = $id")[0];
...
<head>
    ...
    <title>Manager Home | Edit Data Station</title>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="card card-danger">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Data Station</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="kode" class="form-control" id="kode"
                                                        required value="<?php echo $sts["kode"] ?>" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="namastasiun" class="form-control"
                                                        id="namastasiun" required
                                                        value="<?php echo $sts["namastasiun"] ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="lokasi" class="form-control" id="lokasi"
                                                        required value="<?php echo $sts["lokasi"] ?>" />
                                                </div>
                                            </div>
                                        </div>
