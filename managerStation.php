        ...
        <aside class="main-sidebar sidebar-dark-danger elevation-4">
            ...
            <div class="sidebar">
             ...
             with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="managerStation.php" class="nav-link active">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <a href="tambahstasiun.php" class="btn btn-primary btn-sm me-md-2">Tambah
                                            Data</a>
                                    </div>
                                    ...
                                    <table id="dataMobil" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?= $i; ?></td>
                                                <td><?= $row["kode"]; ?></td>
                                                <td><?= $row["namastasiun"]; ?></td>
                                                <td><?= $row["lokasi"]; ?></td>
                                                <td>
                                                    <a href="ubahstasiun.php?id=<?php echo $row["id"] ?>"
                                                        class="btn btn-success btn-sm ">Edit</a>
                                                    <a href="hapusstasiun.php?id=<?php echo $row["id"] ?>"
