                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="main2.php" class="small-box-footer">More info <i
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-pink">
                                ...
                                <a href="successTransaction.php" class="small-box-footer">More info <i
                                        class="nav-icon ion ion-android-arrow-dropright-circle"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                ...
                                <a href="waitingTransaction.php" class="small-box-footer">More info <i
                                        class="nav-icon ion ion-android-arrow-dropright-circle"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                ...
                                <a href="question.php" class="small-box-footer">More info <i
                                        class="nav-icon ion ion-android-arrow-dropright-circle"></i></a>
                            </div>
                        </div>
                    </div>
