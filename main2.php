            ...
            <div class="row">
                <div class="col-md-12 bg-white shadow px-5 py-3 rounded mb-5" id="card-main">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-md-3">
                            <button class="btn btn-primary w-100" id="cariTiket" type="submit" name="submit">
                                Pesan
                            </button>
                        </div>
                    </div>
                ...
                <form role="form" action="" method="POST">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button type="submit2" name="submit2" class="btn btn-primary btn-sm me-md-2">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
