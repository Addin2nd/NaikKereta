...
$data = query("SELECT * FROM datapemesanan WHERE id = $id")[0];


if (isset($_POST["submit"])) {

    // // cek keberhasilan data
    if (konfirmasiTiket($_POST) > 0) {
        echo "
		<script>
...
<head>
    ...
    <title>Staff Home | Ticket Confirmation</title>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="card card-danger">
                                <div class="card-header">
                                    <h3 class="card-title">Ticket Confirmation</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="" method="POST">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="namaPembeli">Customer Name</label>
                                                    <input type="text" name="namaPembeli" class="form-control"
                                                        id="namaPembeli" required
                                                        value="<?php echo $data["namaPembeli"] ?>" />
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="kodeTiket">Ticket Code</label>
                                                    <input type="text" name="kodeTiket" class="form-control"
                                                        id="kodeTiket" required
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="berangkat">From</label>
                                                    <input type="text" name="berangkat" class="form-control"
                                                        id="berangkat" required
                                                        value="<?php echo $data["berangkat"] ?>" />
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="tujuan" class="form-control" id="tujuan"
                                                        required value="<?php echo $data["tujuan"] ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="namaKereta">Train Name</label>
                                                    <input type="text" name="namaKereta" class="form-control"
                                                        id="namaKereta" required
                                                        value="<?php echo $data["namaKereta"] ?>" />
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="tglBerangkat">Departure Date</label>
                                                    <input type="text" name="tglBerangkat" class="form-control"
                                                        id="tglBerangkat" required
                                                        value="<?php echo $data["tglBerangkat"] ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="waktuBerangkat">Departure Time</label>
                                                    <input type="text" name="waktuBerangkat" class="form-control"
                                                        id="waktuBerangkat" required
                                                        value="<?php echo $data["waktuBerangkat"] ?>" />
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="waktuSampai">Arrival Time</label>
                                                    <input type="time" name="waktuSampai" class="input form-control"
                                                        id="waktuSampai" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="kelas" class="form-control" id="kelas"
                                                        required value="<?php echo $data["kelas"] ?>" />
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="noKursi">Seat Number</label>
                                                    <input type="text" name="noKursi" class="input form-control"
                                                        id="noKursi" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="harga" class="input form-control"
                                                        id="harga" />
                                                </div>
                                            </div>
                                        </div>
    ...
    <form action="" method="POST">
        ...
        <ul>
            <li>
                ...
                <input type="text" name="nama_mobil" id="nama_mobil" required value="<?php echo $mbl["nama_mobil"] ?>">

            </li>
            <li>
                <label for="jenis_mobil">jenis_mobil : </label>
                <input type="text" name="jenis_mobil" id="jenis_mobil" required
                    value="<?php echo $mbl["jenis_mobil"] ?>">
            </li>
            <li>
                <label for="harga">harga : </label>
                <input type="text" name="harga" id="harga" required value="<?php echo $mbl["harga"] ?>">
            </li>
            <li>
                <label for="warna">warna : </label>
                <input type="text" name="warna" id="warna" required value="<?php echo $mbl["warna"] ?>">

            </li>
            <li>
                <label for="img">img : </label>
                <input type="text" name="img" id="img" required value="<?php echo $mbl["img"] ?>">
            </li>
            <li>
