...
<head>
    ...
    <title>Manager Home | Add New Train</title>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="card card-danger">
                                <div class="card-header">
                                    <h3 class="card-title">Add New Train</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="" method="POST">
                                    <div class="card-body">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="namakereta" class="form-control"
                                                        id="namakereta" placeholder="Enter train name" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="kelas">Train Class</label>
                                                    <input type="text" name="kelas" class="form-control" id="kelas"
                                                        placeholder="Enter train class" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
